...
...Products : Stores product information such as product ID, product name, category, and price.[Screenshot] (

...Orders:Stores customer orders and the dates on which they were placed.

...Order Items:Stores the individual products included in each order, including the quantity
